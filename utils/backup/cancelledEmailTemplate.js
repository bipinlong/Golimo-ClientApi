...
const cancellationTemplate = (bookingId, userEmail, formattedPickUpDate, formattedPickUpTime, firstName, lastName) => {
    const capitalize = (name) => name.charAt(0).toUpperCase() + name.slice(1).toLowerCase();
    const emailSubject = `Ride Cancellation: Reservation #  #${bookingId} _${capitalize(firstName)} ${capitalize(lastName)} [${formattedPickUpDate} - ${formattedPickUpTime}]`;
    ...
    const emailBody = `
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0;">
                 <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f0f0f0; font-family: Arial, sans-serif; font-size: 12px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
                        <tr style="background-color: #f0f0f0;">
                            <td style="font-size: 12px;padding-left: 45px;"> Ride Cancellation Pending: Reservation #${bookingId}</td>
                ...
                <div style="padding: 20px;">
                    <p style="font-size: 12px; padding-left:40px; padding-right:40px;">
                           Your Ride Cancellation request has been received and is currently under review by our staff. As soon as it is revied and Cancellation is Confirmed you will be notify immediately.
                    </p>
                     <p style="font-size: 12px; padding-left:40px; padding-right:40px;">
                       If you require this Ride Cancellation with in Twelve (12) Hours or need further assistance with this Modification, please contact us by Phone toll-free US/Canada 800.960.0232.        
                       International +1.617.630.0232. We are Here to Assist You 24/7.
                    </p>
               ...
               <td colspan="2" style="padding: 20px 30px;">
                    <p> Your Ride Modification request has been received and is currently under review by our staff. As soon as it is revied and Modification is Confirmed you will be notify immediately.</p>
                    <p>If you require this Ride Modification with in Twelve (12) Hours or need further assistance with this Modification, please contact us by Phone toll-free US/Canada 
                        800.960.0232. International +1.617.630.0232. We are Here to Assist You 24/7.</p>
        ...
        <ul>
           ...
           any damage excess of usual use and wear of Hired Vehicle, there will be a minimum charge of 400.00 USD for the Repair and or General Cleaning of the Vehicle.Decision as to the usual wear and use of the Vehicle Interior
           and its environs, rests with the Company, solely and its experience as to general habitation of hired vehicles and its decision is final.
           </li>
    ...
    const adminEmailBody = `
        <html>
            <body>
                <h3>Admin Notification: Cancellation of Reservation #${bookingId}</h3>
                <p>Customer ${userEmail} has cancelled their reservation for ${formattedPickUpDate} ${formattedPickUpTime}.</p>
                <p>Review the cancellation in the Administration System.</p>
            </body>
        </html>
    `;

    return { emailSubject, emailBody, adminEmailBody };
};
