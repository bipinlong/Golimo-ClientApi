exports.generateBookingModificationEmail = ({ bookingId, firstName, lastName, email, phone, combinedData, returnservice, bookActionType, paymentdetails, account_number }) => {
        ...
        <html>  
            ...
            <div style="font-size: 12px; font-family: Arial, sans-serif;">
                ...
                <p style="margin: 0; line-height: 1.5;margin-bottom: 15px;">
                    Your booking has been successfully modified. Please review the updated Reservation Details and Routing Instructions carefully.
                    If any information is incorrect, please contact our reservation department immediately via email 
                    <a href="mailto:reservations@bostonasapcoach.com">reservations@bostonasapcoach.com</a> 
               ...
               <table style="border-collapse: collapse; width: 100%; font-size: 12px; color: #333; padding-left:20px;">
                <tr>
                    <td style="width: 25%; padding-left: 10px;"><strong>Reservation Date / Day:</strong></td>
                    <td>${formattedDate}</td>
                </tr>
                <tr>
                ...
                `).join('') : ''}
                <tr>
                    <td><strong>Number of Passenger(s):</strong></td>
                    <td>${combinedData?.passengers || '0'}</td>
                </tr>
                <tr>
                    <td><strong>Number of Luggage(s):</strong></td>
           ...
           <table style="border-collapse: collapse; width: 100%; font-size: 12px; color: #333;">
            ...
            <tr>
             ...
             <tr>
                ...
                <td style="width: 50%; padding: 5px;">${account_number}</td>
            </tr>
            <tr>
                <td style="width: 50%; padding: 5px;"><strong>Credit Card Number:</strong></td>
                <td style="width: 50%; padding: 5px;">${maskedCardNumber}</td>
            </tr>
            <tr>
    ...
    emailContent += `
         <div style="font-size: small;">
            ...
            <div style="font-size: 11px; font-family: 'Courier New', Courier, monospace;">
