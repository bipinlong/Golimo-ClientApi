exports.generateBookingModificationEmail = ({ bookingId, firstName, lastName, email, phone, combinedData, returnservice, bookActionType, paymentdetails, account_number, bookingTime  }) => {
                        ...
                        <tr>
                            <td colspan="2">
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding: 10px 30px; font-size:14px; background-color: #eeeeee;">Ride Modification Pending: Reservation#${bookingId}</td>
...
exports.generateAdminBookingModificationEmail = ({ bookingId, firstName, lastName, email, phone, combinedData,formattedTime, returnservice, bookActionType, paymentDetails, billingContact }) => {

    const { pickUpDate, pickUpTime } = combinedData;

   // Converts: Tue May 20 2025 00:00:00 GMT+0530 --> 05-20-2025 - Tuesday
    ...
    const actionHeader = `Ride Modification`
    ...
    if (paymentDetails) {
        emailContent += `
         <table style="border-collapse: collapse; width: 70%; font-size: 12px; color: #333; margin-bottom:5px;">
            ...
            <table style="border-collapse: collapse; width: 70%; font-size: 12px; color: #333;font-family: Arial, sans-serif;">
               ...
               <td>${billingContact ? `${capitalizeName(billingContact.firstName)} ${capitalizeName(billingContact.lastName)}` : ' '}</td>
            </tr>
            <tr>
        ...
        // Only show credit card type if payment method isn't Direct Bill/Invoice
        if (paymentDetails.paymentMethod.toLowerCase() !== 'direct bill/invoice') {
          emailContent += `
             <tr>
